    ...
    <?php include 'header.php'; ?>
      ...
      <div class="body flex-grow-1">
        <div class="container-lg px-4">
          <div class="fs-2 fw-semibold" data-coreui-i18n="แนะนำและติชมการให้บริการแจ้งซ่อม">แนะนำและติชมการให้บริการแจ้งซ่อม</div>
...
<div class="row">
    ...
    <ellipse transform="scale(-1) rotate(45 454 -421.3)" cx="174.5" cy="188" rx="12" ry="8.1" fill="#fff"/>
          ...
          <path d="M290.3 434.8c-1 3.4-5.8 5.2-11 3.9s-8.4-5.1-7.4-8.7c.8-3.3 5.7-5 10.7-3.8 5.1 1.4 8.5 5.3 7.7 8.6z" fill="#fff" opacity=".2"/>
              ...
              <textarea id="feedback" name="feedback" rows="4" cols="80" class="w-100" style="color: black; resize: none;"></textarea>
                    <!-- <input type="text" required="" id="title" name="title" value="" class="form-control-lg" /> -->
                    <label for="title" class=" fs-5 ">คำติชม</label>
              </div>
              </div>

              <div class="subbox">
              <button class="btn btn-success text-white btn-lg btn-sha" style="vertical-align:middle"><span>ส่งคำติชม </span></button>
              <!-- <input  name="subm" class="btn btn-success text-white" value="ส่งคำติชม"> -->
              </div>
