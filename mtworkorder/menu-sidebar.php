<div class="sidebar sidebar-fixed sidebar-dark bg-dark-gradient border-end" id="sidebar">
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        <li class="nav-item"><a class="nav-link" href="/backend/mtworkorder/dashboard.php">
            ...
            <li class="nav-item"><a class="nav-link" href="/backend/mtworkorder/mttaskmain.php">
            <svg class="nav-icon">
            ...
            <li class="nav-item"><a class="nav-link" href="/backend/mtworkorder/mttask.php">
            <svg class="nav-icon">
            ...
            <li class="nav-item"><a class="nav-link" href="/backend/mtworkorder/googlemap.php">
            <svg class="nav-icon">
