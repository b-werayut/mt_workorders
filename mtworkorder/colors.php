    ...
    <div class="wrapper d-flex flex-column min-vh-100">
      ...
      <div class="body flex-grow-1">
        <div class="container-lg px-4">
          <div class="fs-2 fw-semibold" data-coreui-i18n="colors">Colors</div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item"><a href="#" data-coreui-i18n="home">Home</a>
              </li>
              <li class="breadcrumb-item"><span data-coreui-i18n="theme">Theme</span>
              </li>
              <li class="breadcrumb-item active"><span data-coreui-i18n="colors">Colors</span>
              </li>
            </ol>
          </nav>
          <div class="card mb-4">
