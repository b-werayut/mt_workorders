<div class="sidebar sidebar-fixed sidebar-dark bg-dark-gradient border-end" id="sidebar">
      <div class="sidebar-header border-bottom">
        <div class="sidebar-brand">
          <img src="/backend/assets/brand/nwl-logo.png" width="50" alt="">
      ...
      <!-- menu sidebar-left start-->

      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        <li class="nav-item"><a class="nav-link" href="/backend/mtworkorder/dashboard.php">
            <svg class="nav-icon">
              <use xlink:href="/backend/vendors/@coreui/icons/svg/free.svg#cil-speedometer"></use>
            </svg><span data-coreui-i18n="แดชบอร์ด">แดชบอร์ด</span></a></li>
            
            <li class="nav-title" data-coreui-i18n="Services">Services</li>
            <li class="nav-item"><a class="nav-link" href="/backend/mtinternal/mttaskinmain.php">
            <svg class="nav-icon">
            <use xlink:href="/backend/vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
            </svg><span data-coreui-i18n="หน้าหลัก">หน้าหลัก</span></a></li>
            <li class="nav-item"><a class="nav-link" href="/backend/mtinternal/mttaskin.php">
            <svg class="nav-icon">
            <use xlink:href="/backend/vendors/@coreui/icons/svg/free.svg#cil-spreadsheet"></use>
            </svg><span data-coreui-i18n="ตารางใบแจ้งซ่อม">ตารางใบแจ้งซ่อม</span></a></li>
            <li class="nav-item"><a class="nav-link" href="/backend/mtinternal/googlemap.php">
            <svg class="nav-icon">
            <use xlink:href="/backend/vendors/@coreui/icons/svg/free.svg#cil-map"></use>
            </svg><span data-coreui-i18n="แผนที่">แผนที่</span></a></li>
            

        <!-- <li class="nav-title" data-coreui-i18n="theme">Theme</li>
        <li class="nav-item"><a class="nav-link" href="colors.html">
            <svg class="nav-icon">
              <use xlink:href="/backend/vendors/@coreui/icons/svg/free.svg#cil-drop"></use>
        ...
        <li class="nav-item"><a class="nav-link" href="calendar.html">
            <svg class="nav-icon">
              <use xlink:href="/backend/vendors/@coreui/icons/svg/free.svg#cil-calendar"></use>
            </svg><span data-coreui-i18n="calendar">Calendar</span><span class="badge bg-danger-gradient ms-auto">PRO</span></a></li>
        <li class="nav-item"><a class="nav-link" href="charts.html">
            <svg class="nav-icon">
              <use xlink:href="/backend/vendors/@coreui/icons/svg/free.svg#cil-chart-pie"></use>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
          ...
          <ul class="nav-group-items compact">
            ...
            <li class="nav-item"><a class="nav-link" href="404.html" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="/backend/vendors/@coreui/icons/svg/free.svg#cil-bug"></use>
